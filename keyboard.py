...
keyboard_buttons = [
    ...
    ('.', 660, 240, 50, 50, 'pink'),
    ('Shift', 720, 240, 150, 50, 'gray'),

    # --- 6 ряд (Bottom row) ---
    ('Ctrl', 0, 300, 70, 50, 'gray'),
    ('Win', 80, 300, 70, 50, 'gray'),
    ('Alt', 160, 300, 70, 50, 'gray'),
    ('Space', 240, 300, 280, 50, 'orange'),
    ('Alt', 530, 300, 70, 50, 'gray'),
    ('Win', 610, 300, 70, 50, 'gray'),
    ('Menu', 690, 300, 70, 50, 'gray'),
    ('Ctrl', 770, 300, 70, 50, 'gray'),
]
